...
birler_basamagi = {"0": "", "1":"Bir", "2":"iki", "3":"Uc", "4":"Dort", "5":"Bes", "6":"Alti", "7":"Yedi", "8":"Sekiz", "9": "Dokuz"}
...
def numberText(number):
    ...
    while string_number_list:
        ...
        elif step % 3 == 0 and string_number_list[0] == "1":
        ...
        if step % 3 == 2 and string_number_list[0] != "1":
            my_number_list.append("Yuz")
        if step % 3 == 0:
            my_number_list.append(step_dictionary[str(step)])
    print " ".join(my_number_list[::-1])

numbers = raw_input("write your number:")
